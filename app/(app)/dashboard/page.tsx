          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-destructive/80">
                Przekroczyłeś budżet w{" "}
                {budgetAlerts.filter((a) => a.type === "exceeded").length}{" "}
                {budgetAlerts.filter((a) => a.type === "exceeded").length === 1
                  ? "kategorii"
                  : "kategoriach"}
                .
              </p>
              ...
              <div key={alert.id}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm">
                    {alert.spent.toLocaleString("pl-PL")} /{" "}
                    {alert.budget.toLocaleString("pl-PL")} zł
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between mt-1">
                  ...
                  {alert.type === "exceeded" && (
                    <span className="text-xs text-destructive">
                      Przekroczono o {alert.spent - alert.budget} zł
                    </span>
                  )}
                </div>
              </div>
