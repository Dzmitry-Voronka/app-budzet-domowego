    ...
    <div className="bg-white rounded-lg shadow-sm border border-border overflow-hidden">
      <div className="p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="p-2 hover:bg-muted rounded transition-colors" aria-label="Edytuj">
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-2 border border-border inline-flex gap-2">
        {(["all", "expense", "income"] as const).map((type) => (
          ...
          >
            {type === "all" ? "Wszystkie" : type === "expense" ? "Wydatki" : "Przychody"}
          </button>
        ))}
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
            ...
            <form onSubmit={handleAddCategory} className="p-6 space-y-4">
              ...
              <div>
                <label htmlFor="categoryColor" className="block mb-2">
                  Kolor
                </label>
